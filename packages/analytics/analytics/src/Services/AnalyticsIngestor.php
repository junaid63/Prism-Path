...
use UltraClarity\Analytics\Events\LiveSessionUpdated;
use UltraClarity\Analytics\Jobs\ProcessAnalyticsJob;
    ...
    public function ingest(Request $request): Session
    {
        ...
        $visitor = Visitor::updateOrCreate(
            ...
            [
                ...
                'country' => $request->header('CF-IPCountry') ?: ($request->header('X-UltraClarity-Country') ?: null),
                'city' => $request->header('X-UltraClarity-City'),
